const messages = [
  ...
  "you're so supportive as well!! whether that be spending your time with your friends or hiring your friends (like nadia!), you have always been so supportive. you're also incredibly patient with us (esp given some staff can... well.). i feel like i could go to you for anything, and it means a lot ♡",
...
function showText(index) {
  document.getElementById("letterText").innerText = messages[index];
}
